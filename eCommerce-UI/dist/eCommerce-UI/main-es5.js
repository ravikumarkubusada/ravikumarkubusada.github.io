  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 12,
        vars: 5,
        consts: [[1, "navbar", "navbar-light", "fixed-top", "bg-light"], [1, "navbar-brand", 3, "routerLink"], ["src", "assets/logo/bootstrap-solid.svg", "width", "30", "height", "30", "alt", "logo", 1, "d-inline-block", "align-top"], [1, "form-inline"], ["type", "search", "placeholder", "Search Products", "name", "searchText", 1, "form-control", "mr-sm-2", 3, "ngModel", "ngModelChange"], ["type", "submit", 1, "btn", "btn-outline-primary", 3, "routerLink"], ["aria-hidden", "true", 1, "fa", "fa-shopping-cart"], ["class", "badge badge-primary", 4, "ngIf"], [1, "mr-top-6"], [1, "badge", "badge-primary"]],
        template: function AppComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            })("ngModelChange", function AppComponent_Template_input_ngModelChange_6_listener() {
        ...
        _createClass(ProductCatalogComponent, [{
          ...
          value: function filterProductsTxt(searchText) {
            ...
            this.productList = this.productList.filter(function (o) {
              var res = o.name.match(searchText);
